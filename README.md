...
- **Updated 05/08/2025**: Added 25t2 data. Some players ran a discrepancy of laps that did not match 4. I applied Riegel's Model taking k = 1.2 for Jackie Tran (2 laps), Sabrina (2 laps) and Heejae (3 laps) and k = 1.0 for Will (5 laps) to approximate their 4 lap results. Had to fix some of the names so that there wouldnt be clashes by adding the suffix 25t2
- **Updated 21/11/2025**: Added 25t3 data. Some players ran a discrepancy of laps that did not match 4. I applied Riegel's Model taking k = 1.2 for Lydia (2 laps), Rosabella (2 laps), Brian (2 laps) and k = 1.0 for Will (2 laps) to approximate their 4 lap results. Fixed new pb appearing for future attempts that have the same time. Fixed data typo where kevin from 25t2 is a new kevin (kevin -> kevin (weeb)). Fixed 25t2 naming convention for some players (Ben 25t2 -> Ben Pa., Will 25t2 -> Will Od.) Fixed gender in 25t2 results of Monica (male -> Female)
- **Updated 29/04/2026**: Added 26t1 data. Some players ran a discrepancy of laps that did not match 4. I applied Riegel's Model taking k = 1.06 for Jimmy, Dylan, Tim and Jacky Wang (1 lap) and Modi (2 laps). Fixed naming: Ben Pa. from 25t2, 25t3 to Minje, Fabiem from 25t3 to Fabien, Maggy from 25t2 to Maggie.